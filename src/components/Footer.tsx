      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <Link href="/" className="text-xl font-bold text-foreground flex items-center gap-2 mb-4">
              <span className="text-primary">N</span>
              <span>Narender Nain</span>
            </Link>
            <p className="text-foreground-muted text-sm max-w-md">
              Software engineer specializing in backend development, machine learning, and fintech solutions. 
              Building robust and scalable systems with a focus on performance and reliability.
            </p>
          </div>
          
          <div>
            <h3 className="text-foreground font-medium mb-4">Links</h3>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-foreground-muted text-sm">
            © {currentYear} Narender Nain. All rights reserved.
          </p>
